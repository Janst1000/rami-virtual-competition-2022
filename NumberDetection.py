...
class NumberDetector:
    def __init__(self, weights, imgsz=640, trace=False, half=False, augment=False, conf_thres = 0.25, iou_thres = 0.45):
    ...
    def detect(self, weights, img, trace=False, augment=False, conf_thres = 0.25, iou_thres = 0.45):
